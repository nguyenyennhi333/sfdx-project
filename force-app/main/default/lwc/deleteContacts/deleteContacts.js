...
import fetchContactRecord from '@salesforce/apex/ContactController.fetchContactRecord';
import deleteMultipleContactRecord from '@salesforce/apex/ContactController.deleteMultipleContactRecord';
import { refreshApex } from '@salesforce/apex';
import {ShowToastEvent} from 'lightning/platformShowToastEvent';
 
 
export default class DeleteContacts extends LightningElement {
    @api  columns = [
